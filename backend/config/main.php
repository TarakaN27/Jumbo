...
return [
    ...
    'components' => [
        ...
        'authManager' => [
            ...
            'defaultRoles' => ['user','jurist','e_marketer','moder','sale','bookkeeper','admin','superadmin','partner_manager','teamlead','teamlead_acc','teamlead_sale','hr'], //здесь прописываем роли
