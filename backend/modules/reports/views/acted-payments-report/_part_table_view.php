    ...
    <thead>
        <tr>
            ...
            <th><?=Yii::t('app/reports','iProfitTotal')?></th>
                <th><?=Yii::t('app/reports','iActedProfitTotal')?></th>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <td>
                    <?=Yii::$app->formatter->asDecimal($model['iActedProfitTotal']);?>
                </td>
            <td>
...
<table class="table table-bordered container-result width-100-percent">
    ...
    <?php foreach($model['data'] as $key => $data):?>
        ...
        <tr>
            ...
            <th class="width-8-percent"><?=Yii::t('app/reports','Profit acted BYR')?></th>
        ...
        <tr>
            ...
            <td class="width-8-percent">
                    <?=($dt['profit'] ? Yii::$app->formatter->asDecimal($dt['profit']* ($dt['acted_sum']/$dt['pay_summ'])) : 'N/A');?>
            </td>
            <td class="width-8-percent">
        ...
        <tr class="wm-tr-total">
            ...
            <td>
                ...
                <td>
                    <?=isset($model['totalGroupActedProfit'][$key]) ? Yii::$app->formatter->asDecimal($model['totalGroupActedProfit'][$key]) : '-';?>
                </td>
            <td>
