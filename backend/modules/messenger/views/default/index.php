        ...
        <div class = "x_panel">
            <div class = "x_title">
                ...
                <section class="pull-right">
                    <?php echo \yii\helpers\Html::button(
                        Yii::t('app/msg','Add new dialog').' '.'<i class = "fa fa-chevron-down"></i>',[
                        'id' => 'add_new_dialog_id'
                    ])?>
                </section>
                    ...
                    <div class="col-sm-9 mail_view" >
                        <div class="inbox-body">
                            ...
                            <div class="compose-btn pull-left">
                                <button class="btn btn-sm btn-add-comment">
                                    <i class="fa fa-reply"></i> Add comment</button>
                                </button>
                            </div>
                            <div class = "clearfix"></div>
