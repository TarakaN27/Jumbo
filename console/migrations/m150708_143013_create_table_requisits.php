...
class m150708_143013_create_table_requisits extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%cuser_requisites}}', [
            'id' => Schema::TYPE_PK,
            'corp_name' => Schema::TYPE_STRING . ' NOT NULL',
            'j_fname' => Schema::TYPE_STRING . ' NOT NULL',
            'j_lname' => Schema::TYPE_STRING . ' NOT NULL',
            'j_mname' => Schema::TYPE_STRING . ' NOT NULL',
            'j_post' => Schema::TYPE_STRING . ' NOT NULL',
            'j_doc' => Schema::TYPE_STRING . ' NOT NULL',
            ...
            'j_address' => Schema::TYPE_TEXT . ' NOT NULL',
            'p_address' => Schema::TYPE_TEXT . ' NOT NULL',

            'c_fname' => Schema::TYPE_STRING . ' NOT NULL',
            'c_lname' => Schema::TYPE_STRING . ' NOT NULL',
            'c_mname' => Schema::TYPE_STRING . ' NOT NULL',
