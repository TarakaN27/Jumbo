...
namespace common\components\dumpingDB;


use yii\base\Component;
use yii\base\InvalidConfigException;

class DumpingDB extends Component{
    ...
    private $db = NULL,
    $db_connected = NULL,
    $max_query_size = 50,   //max size of the query in megabytes - this value will be multiplied by 1024.
    ...
    {
        parent::init();
        if(empty($this->filePath) || is_dir($this->filePath))
            throw new InvalidConfigException("You  must set file directory");
