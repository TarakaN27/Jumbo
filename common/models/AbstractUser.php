...
class AbstractUser extends ActiveRecord implements IdentityInterface
{
    ...
    //общие роли как бекенд так и фронтенд пользователей
    CONST ROLE_USER = 5;
    ...
    {
        return [
            self::STATUS_ACTIVE => Yii::t('app/users','USER_status_active'),
            self::STATUS_BLOCKED => Yii::t('app/users','USER_status_blocked')
        ];
    }

    /**
     * Получаем статус строкой
     * @return string
     */
    ...
    /**
     * Добавим ключ автоматической аутентификации
     * @param bool $insert
     * @return bool
     */
