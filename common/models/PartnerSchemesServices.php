...
/**
 * This is the model class for table "{{%partner_schemes_services}}".
 *
 * @property integer $id
 ...
 */
class PartnerSchemesServices extends AbstractActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%partner_schemes_services}}';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'group_id' => Yii::t('app/users','Partner services Group id')
        ];
    }
    ...
    public function beforeValidate()
    {
        if(is_array($this->ranges))
            $this->ranges = Json::encode($this->ranges);

        if(is_array($this->legal))
            $this->legal = Json::encode($this->legal);
